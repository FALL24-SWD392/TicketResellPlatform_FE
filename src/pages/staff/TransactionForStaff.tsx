...
function TransactionsForStaff() {
  ...
  const { data, isLoading, isError, error } = useQuery({
    ...
    queryFn: () => authAPI.Gettransaction() // Ensure this endpoint is correct for staff
  })
  ...
  // Render status badge for each transaction
  ...
  // Handle error if there's a failure in fetching data
  if (isError) {
          ...
          {isLoading ? (
            ...
            <Table aria-label='Transactions Table'>
              ...
              <TableBody emptyContent={<div className='text-center py-12 text-gray-500'>No transactions found</div>}>
                {/* Loop through transactions data and display */}
...
export default TransactionsForStaff
